...
function twentytwelve_entry_meta() {
	...
	if ( $tag_list ) {
		$utility_text = __( 'Dette innlegget ble postet i %1$s og tagget %2$s på %3$s<span class="by-author"> av %4$s</span>.', 'twentytwelve' );
	} elseif ( $categories_list ) {
		$utility_text = __( 'Dette innlegget ble postet i %1$s på %3$s<span class="by-author"> av %4$s</span>.', 'twentytwelve' );
	} else {
		$utility_text = __( 'Dette innlegget ble postet %3$s<span class="by-author"> av %4$s</span>.', 'twentytwelve' );
	}
